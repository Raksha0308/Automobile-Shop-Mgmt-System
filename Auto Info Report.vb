...
Public Class Auto_Info_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Auto_Mgmt.Auto Info Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAuto_Info_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Auto_Info_Report = New Auto_Info_Report
        rpt.Site = Me.Site
        Return rpt
    End Function
